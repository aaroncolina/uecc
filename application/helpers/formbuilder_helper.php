...
function build_page($page_dir, $data){
	$CI =& get_instance();
	...
	$data['right_side_navbar'] = $CI->load->view('template/right_side_navbar.php', $data, true);
	...
	if(isset($_GET['is_ajax_call']) && $_GET['is_ajax_call']==true){
		echo json_encode($data['view_page'] . $data['js']);
	} else {

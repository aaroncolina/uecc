...
CREATE TABLE `m_members` (
  ...
  `member_active` enum('Y','N') DEFAULT 'Y',
...
INSERT INTO `m_members` VALUES (1,NULL,'Aaron Andrew','Magsino','Colina','M','1995-07-13','Y','Y','xenon757',NULL,'ADMIN','2018-01-16 14:53:37');
/*!40000 ALTER TABLE `m_members` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'uecc_db'
--
...
-- Dump completed on 2018-01-16 23:44:36
